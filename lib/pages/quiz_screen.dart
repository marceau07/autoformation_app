...
class QuizPageState extends State<QuizScreen> {
  ...
  final Map<int, String> _selectedAnswers =
      {}; // Map pour stocker les réponses sélectionnées
  ...
  void _sendResult(Map<int, String> selectedAnswers) {
    ApiService().sendResult("403201e3-4513-11ef-a047-0afbcf1b1a30",
        widget.quizUuid, selectedAnswers);
  }

  void _selectAnswer(String selectedOption, List<Question> questions) {
    setState(() {
      _selectedAnswers[_currentQuestionIndex] = selectedOption;
      print('Réponses sélectionnées: $_selectedAnswers');
    });
    ...
    return Scaffold(
        ...
        appBar: AppBar(
          ...
          title: FutureBuilder<String>(
            future: ApiService().fetchModuleTitle(widget.quizUuid),
            builder: (context, snapshot) {
              if (snapshot.connectionState == ConnectionState.waiting) {
                ...
                return Text(
                  snapshot.data ?? "Titre Indisponible",
          ...
          builder: (context, snapshot) {
            if (snapshot.connectionState == ConnectionState.waiting) {
              ...
              Color themeColor = question.theme != null
                  ? Color(
                      int.parse('0xFF${question.theme!.color.substring(1)}'))
                        ...
                        Padding(
                          ...
                          child: ElevatedButton(
                            onPressed: () => _nextQuestion(
                                questions), // Désactiver si la dernière question
                            child: Text(
